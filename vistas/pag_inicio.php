    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">SOFTRECORD</a>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown notification">
                            <a class="nav-link nav-icons" id="navbarDropdownMenuLink1"
                             aria-haspopup="true" aria-expanded="false"  href="paginas/user.php">Usuarios
                        ...
                        <ul class="navbar-nav flex-column">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="paginas/proveedores.php">Proveedores</a>
                                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="paginas/venta.php">Ventas<span class="badge badge-secondary"></span></a>
                                        </li>
                                        <li class="nav-item">
                                        <a class="nav-link" href="paginas/devoluciones.php">Devoluciones<span class="badge badge-secondary"></span></a>
                                        </li>
     ...
     <h2 class="card-header">Manejo de Inventarios</h2> 
  
  <h5 class="text-center">Usuario: <span class="badge badge-primary"><?php echo $_SESSION["s_usuario"];?></span></52> 
  <div class="card-body">
    
    <img src="imagen/almacen.png" alt="...">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2021. Nanci Uicab - Cristina Mis - Beatriz Cohuo</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
